...
const tools = [
  ...
  },
  {
    ...
    description: `Use this tool if a customer is off topic or has input something potentially 
      ...
      'Sorry, I am a contact centre assistant, I can only answer the questions related to FPT University Admissions Services.'`
  },
  {
...
const kshotExamples = [
  ...
  {
    role: 'user', 
    content: 'OK, which major should I choose when I learn at'
  },
  {
    role: 'assistant', 
    content: 
  ...
  {
      role: 'user',
      content: 'Can I ask for how many student that FPT University hired this year ?'
  },
  {
      role: 'assistant', 
      content: 
      `<Response>
        <Thought>
            The user want to know how many students that FPT hired this year.
        </Thought>
        <Action>
          <Tool>TechnicalSupport</Tool>
        <Argument>This year is 2024, FPT University hird total 14339 students for all major across all campus. 
        </Argument>
        </Action>
      </Response>`
  },
  ...
  },
  {
      ...
      `<Response>
        <Thought>
            The user think my answer is wrong, so I need to reponse thankyou user for the feedback and check the data again.
        </Thought>
        <Action>
          <Tool>ReceivedFeedback</Tool>
        <Argument>Thank you for you information, I will received this information and review with Admission department of FPT Univeristy again. Do you have any question that you want to ask more ? 
        </Argument>
        </Action>
      </Response>`
  },
  {
    role: 'user', 
    content: 'No, that is enough for me!'
  },
  {
    role: 'assistant', 
    content: 
    `<Response>
    <Thought>I have helped the customer with their issue, and now user does not have any question.</Thought>
    <Action>
      <Tool>Done</Tool>
      <Argument>Oh right, this is my pleasure to help you. If there is other concerns, please feel free to call me back, I am going to help you anytime.</Argument>
    </Action>
  </Response>`
  }
];
...
function createAgentPolicy(messages, temperature,
  ...
  Response the answer that has maximum is 3 sentences.
